  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-5(data-aos="zoom-in-down")
      .col-12
        .titulo-sexto.color-acento-contenido.mb-5
          p.titulo.pb-0.mb-0 #[b Figura 1.] <em>Expectativas financieras</em>
        figure
          img.d-none.d-sm-none.d-md-block(src='@/assets/curso/temas/tema1/img-1-v1.svg', alt='Infografía que relaciona los aspectos financieros presentes en una empresa.')  
          img.d-block.d-md-none(src='@/assets/curso/temas/tema1/img-1-v2.svg', alt='Infografía que relaciona los aspectos financieros presentes en una empresa.') 
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-12(data-aos="zoom-in-down")
        .titulo-sexto.color-acento-contenido.mb-5
          p.titulo.pb-0.mb-0 #[b Figura 2.] <em>Características</em>
        figure
          img.mb-2.d-none.d-sm-none.d-md-block(src='@/assets/curso/temas/tema1/img-2-v1.svg', alt='Imagen que relaciona las características presentes en los activos y pasivos financieros.')
          img.mb-2.d-block.d-md-none(src='@/assets/curso/temas/tema1/img-2-v2.svg', alt='Imagen que relaciona las características presentes en los activos y pasivos financieros.')
    ...
    .row.justify-content-center.mt-5.mb-2.d-none.d-sm-none.d-md-block
      .col-12(data-aos="zoom-in-down") 
        ImagenInfograficaB.color-acento-botones.mb-4
          ...
          .tarjeta.color-acento-contenido1.p-3(x="5%" y="16.5%" numero="1" tooltip="Abrir recurso")
          ...
          .tarjeta.color-acento-contenido1.p-3.texto-negro(x="85%" y="10.5%" numero="2" tooltip="Abrir recurso")
            p Corresponde a los instrumentos financieros ofrecidos por empresas o entes económicos de naturaleza privada.

          .tarjeta.color-acento-contenido1.p-3.texto-negro(x="85%" y="22.5%" numero="3" tooltip="Abrir recurso")
            p Corresponde a la oferta financiera ofrecida por una entidad pública, como las empresas estatales, las naciones, etc.
              
          .tarjeta.color-acento-contenido1.p-3.texto-negro(x="5%" y="50%" numero="4" tooltip="Abrir recurso")
          ...
          .tarjeta.color-acento-contenido1.p-3.texto-negro(x="85%" y="61.5%" numero="7" tooltip="Abrir recurso")
          ...
          .tarjeta.color-acento-contenido1.p-3.texto-negro(x="5%" y="83%" numero="8" tooltip="Abrir recurso")
          ...
          .tarjeta.color-acento-contenido1.p-3.texto-negro(x="85%" y="77%" numero="9" tooltip="Abrir recurso")
    ...
    .row.justify-content-center.mt-5
      .col-12(data-aos="zoom-in-down") 
        ImagenInfografica.color-acento-botones.mb-4.d-none.d-sm-none.d-md-block
          template(v-slot:imagen)
            figure
              img(src='@/assets/curso/temas/tema1/img-4-v1.svg', alt='')

          .tarjeta.color-acento-contenido1.p-3.texto-negro(x="6%" y="16.5%" numero="+")
            p Pasivos financieros según su plazo de exigibilidad 
            p La clasificación más usada para distinguir los pasivos financieros toma como referencia el tiempo en el cual el ente generador de la obligación deba cumplir con el pago de las retribuciones establecidas en el contrato, puesto que entendemos como pasivos financieros a aquellos beneficios que se encuentran comprometidos para pago en un tiempo determinado, dado esto podemos distinguir dos tipos: a corto y largo plazo.
          
          .tarjeta.color-acento-contenido1.p-3.texto-negro(x="7.5%" y="41.5%" numero="+")
            p También conocidos como pasivos corrientes. Son resultado del desarrollo de las actividades ordinarias del ente económico generador; dichas obligaciones exigen que el tiempo de su liquidación sea inferior a un año.
          
          .tarjeta.color-acento-contenido1.p-3.texto-negro(x="7.5%" y="60%" numero="+")
          ...
          .tarjeta.color-acento-contenido1.p-3.texto-negro(x="90%" y="58%" numero="+")
            p Agrupa a todos aquellos pasivos financieros emitidos con el propósito de ser ofertados en mercados financieros para su compra y venta a mediano y largo plazo. Dado las condiciones del mercado en el que se mueven y el plazo de exigibilidad de su obligación, son susceptibles a cambios variados en su valor como consecuencia de las fluctuaciones en las condiciones económicas tanto del emisor como de la oferta y demanda del mercado.

          .tarjeta.color-acento-contenido1.p-3.texto-negro(x="94%" y="82%" numero="+")
            p Pasivos financieros según su gestión
            p De acuerdo al tipo de gestión que exigen, el origen de su hecho económico y las condiciones del mercado al que pertenecen, se pueden distinguir tres tipos de pasivos financieros, estos son: pasivos para negociar, derivados y pasivos a valor razonable.
